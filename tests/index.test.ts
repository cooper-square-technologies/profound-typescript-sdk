...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new Profound({ logger: logger, logLevel: 'debug', queryAPIKey: 'My Query API Key' });
    ...
    test('default logLevel is warn', async () => {
      const client = new Profound({ queryAPIKey: 'My Query API Key' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new Profound({ logger: logger, logLevel: 'info', queryAPIKey: 'My Query API Key' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      const client = new Profound({ logger: logger, queryAPIKey: 'My Query API Key' });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['PROFOUND_LOG'] = 'debug';
      const client = new Profound({ logger: logger, logLevel: 'off', queryAPIKey: 'My Query API Key' });
  ...
  describe('baseUrl', () => {
    ...
    test('explicit option', () => {
      const client = new Profound({ baseURL: 'https://example.com', queryAPIKey: 'My Query API Key' });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Profound({ maxRetries: 4, queryAPIKey: 'My Query API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Profound({ queryAPIKey: 'My Query API Key' });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['PROFOUND_API_KEY'] = 'My Query API Key';
    const client = new Profound();
    expect(client.queryAPIKey).toBe('My Query API Key');
  });

  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['PROFOUND_API_KEY'] = 'another My Query API Key';
    const client = new Profound({ queryAPIKey: 'My Query API Key' });
    expect(client.queryAPIKey).toBe('My Query API Key');
  });
});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Profound({ queryAPIKey: 'My Query API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Profound({ queryAPIKey: 'My Query API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Profound({ queryAPIKey: 'My Query API Key', fetch: testFetch });
