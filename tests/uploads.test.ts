import fs from 'fs';
import type { ResponseLike } from '@profoundai/client/internal/to-file';
import { toFile } from '@profoundai/client/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@profoundai/client/core/uploads');
    await expect(
