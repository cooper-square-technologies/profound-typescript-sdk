...
This is the first release generated by our new SDK generator. Method and type names changed across the board; the set of API endpoints changed only as noted below. This SDK is pre-1.0 and in beta.


### ⚠ BREAKING CHANGES

* **api:** most methods and schema types were renamed by the new generator — see [api.md](./api.md) for the current surface.
...
* **api:** regenerated the SDK on the new generator ([18c978f](https://github.com/cooper-square-technologies/profound-typescript-sdk/commit/18c978ffafe6ddf12c5afbafe27d4e1ee30b121a))
