...
/**
 * Filter by bot name (user agent). Values come from analytics data and should not
 * be enum-constrained because web-v2 may send newly cataloged user-agent names.
 */
