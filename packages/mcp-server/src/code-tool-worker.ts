...
const fuse = new Fuse(
  [
    ...
    'client.reports.shopping.executions',
    'client.reports.shopping.itemVisibility',
    'client.reports.shopping.merchantByItems',
    'client.reports.shopping.merchantDistribution',
    'client.reports.shopping.merchantShare',
    'client.reports.shopping.merchantVisibilityByBrand',
    'client.reports.shopping.productMerchantURLs',
    'client.reports.shopping.triggerRate',
    'client.reports.shopping.visibility',
