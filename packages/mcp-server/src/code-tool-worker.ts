...
const fuse = new Fuse(
  [
    ...
    'client.organizations.categories.getCitationCategories',
    'client.organizations.categories.list',
    'client.organizations.categories.prompts',
    'client.organizations.categories.retrieveRegions',
    ...
    'client.prompts.answersV2',
    'client.prompts.streamAnswersV2',
    ...
    'client.reports.queryCitations',
    'client.reports.queryFanouts',
    'client.reports.queryQueryFanouts',
    'client.reports.querySentiment',
    'client.reports.queryVisibility',
    'client.reports.sentiment',
    'client.reports.sentimentV2',
    'client.reports.streamCitations',
    'client.reports.streamCitationsV2',
    'client.reports.streamQueryFanouts',
    'client.reports.streamSentiment',
    'client.reports.streamSentimentV2',
    'client.reports.streamVisibility',
    'client.reports.streamVisibilityV2',
    ...
    'client.reports.shopping.streamBrands',
    'client.reports.shopping.streamMerchants',
    'client.reports.shopping.streamProducts',
    'client.reports.shopping.streamTriggerRate',
    'client.reports.shopping.triggerRate',
    'client.reports.accuracy.createBreakdown',
    'client.reports.accuracy.createCitationAnalysis',
    'client.reports.accuracy.createClaimBreakdown',
    'client.reports.accuracy.createClaimCitations',
    'client.reports.accuracy.createClusterExampleRuns',
    'client.reports.accuracy.createClusterVerificationPairs',
    'client.reports.accuracy.createFactcheckSetupStatus',
    'client.reports.accuracy.createInaccuracyDrivers',
    'client.reports.accuracy.createInaccurateClusters',
    'client.reports.accuracy.createInaccurateThemes',
    ...
    'client.reports.factcheck.queryScores',
    'client.reports.factcheck.streamScores',
    'client.reports.factcheck.claims.queryClaims',
    'client.reports.factcheck.claims.streamClaims',
    'client.reports.social.youtube.getChannels',
    'client.reports.social.youtube.getSummary',
    'client.reports.social.youtube.getVideos',
    ...
    'client.agents.nodeTypes.list',
    'client.agents.nodeTypes.retrieveSchema',
    'client.knowledgeBases.list',
    'client.knowledgeBases.search',
    'client.knowledgeBases.documents.create',
    'client.knowledgeBases.documents.delete',
    'client.knowledgeBases.documents.update',
    'client.knowledgeBases.folders.create',
    'client.knowledgeBases.folders.delete',
    'client.projects.archive',
    'client.projects.create',
    'client.projects.delete',
    'client.projects.getStatus',
    ...
    'client.documents.replaceContent',
