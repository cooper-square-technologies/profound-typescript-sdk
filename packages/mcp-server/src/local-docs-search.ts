...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    "response": "{ data: { id: string; created_at: string; language: string; platforms: object[]; prompt: string; prompt_type: string; regions: object[]; status: 'active' | 'disabled'; topic: object; updated_at: string; personas?: object[]; tags?: object[]; }[]; info: { limit: number; next_cursor: string; total_rows: number; }; }",
  ...
  },
  {
    ...
    "response": "{ dry_run: boolean; created?: number; prompts?: { id: string; language: string; prompt: string; prompt_type: string; topic: object; asset?: object; personas?: object[]; platforms?: object[]; regions?: object[]; tags?: object[]; }[]; tags_created?: number; topics_created?: number; }",
  ...
  },
  {
    ...
    "response": "{ dry_run: boolean; prompts?: { id: string; asset?: object; language?: object; personas?: object; platforms?: object; prompt?: object; prompt_type?: object; regions?: object; tags?: object; topic?: object; }[]; tags_created?: number; topics_created?: number; updated?: number; }",
