...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ domain: string; href: string; markdownContent: string; pageTitle: string; claims?: { attribute: string; attributeId: string; claim: string; claimId: string; neutralTheme: string; neutralThemeId: string; snippet: string; kbPath?: string; kbSnippet?: string; polarity?: 'positive' | 'negative'; }[]; }",
    markdown:
      "## create_citation_analysis\n\n`client.reports.accuracy.createCitationAnalysis(category_id: string, clean_href: string, end_date: string, start_date: string): { domain: string; href: string; markdownContent: string; pageTitle: string; claims?: object[]; }`\n\n**post** `/v1/reports/accuracy/citation-analysis`\n\nAccuracy Citation Analysis\n\n### Parameters\n\n- `category_id: string`\n\n- `clean_href: string`\n\n- `end_date: string`\n\n- `start_date: string`\n\n### Returns\n\n- `{ domain: string; href: string; markdownContent: string; pageTitle: string; claims?: { attribute: string; attributeId: string; claim: string; claimId: string; neutralTheme: string; neutralThemeId: string; snippet: string; kbPath?: string; kbSnippet?: string; polarity?: 'positive' | 'negative'; }[]; }`\n\n  - `domain: string`\n  - `href: string`\n  - `markdownContent: string`\n  - `pageTitle: string`\n  - `claims?: { attribute: string; attributeId: string; claim: string; claimId: string; neutralTheme: string; neutralThemeId: string; snippet: string; kbPath?: string; kbSnippet?: string; polarity?: 'positive' | 'negative'; }[]`\n\n### Example\n\n```typescript\nimport Profound from '@profoundai/client';\n\nconst client = new Profound();\n\nconst response = await client.reports.accuracy.createCitationAnalysis({\n  category_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n  clean_href: 'clean_href',\n  end_date: 'end_date',\n  start_date: 'start_date',\n});\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
