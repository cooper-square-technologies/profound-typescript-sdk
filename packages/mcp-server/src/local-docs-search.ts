...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ count: number; end_date: string; include: string[]; models: string[]; start_date: string; filter?: object; next_cursor?: string; total_results?: number; } | { analysis_types?: string[]; citation_details?: { clean_url: string; hostname: string; path: string; title: string; url: string; citation_category?: string; first_cited_at?: string; text?: string; }[]; citations?: string[]; date?: string; mentions?: string[]; model?: { id?: string; name?: string; }; persona?: string; prompt?: string; prompt_id?: string; region?: string; response?: string; run_id?: string; search_queries?: string[]; sentiment_claims?: object[]; tags?: string[]; topic?: string; topic_id?: string; }',
    markdown:
