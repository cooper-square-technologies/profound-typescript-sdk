...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      "typescript": {
        ...
        "example": "import Profound from 'profoundai';\n\nconst client = new Profound({\n  apiKey: process.env['PROFOUND_API_KEY'], // This is the default and can be omitted\n});\n\nconst namedResources = await client.organizations.regions();\n\nconsole.log(namedResources);"
      },
      "python": {
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; name: string; organization: { id: string; name: string; }; }[]",
  ...
  },
  {
    ...
    "httpMethod": "get",
    "summary": "Get Assets",
    "description": "Get the organization assets, one row per (asset, organization) pair.\n\nAn asset's category can belong to multiple organizations; one asset row is\nemitted per owning org so no association is silently dropped.",
    "stainlessPath": "(resource) organizations > (method) list_assets",
    "qualified": "client.organizations.listAssets",
    "params": [
      "organization_ids?: string[];"
    ],
    "response": "{ data: { id: string; category: object; created_at: string; is_owned: boolean; logo_url: string; name: string; organization: object; website: string; alternate_domains?: string[]; }[]; }",
  ...
  },
  {
    ...
    "description": "Return every organization the caller's API key grants access to. Use this to discover organization IDs before calling endpoints that accept an `organization_id` filter.",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/org/categories \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/org/categories/$CATEGORY_ID/topics \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/org/categories/$CATEGORY_ID/tags \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieve prompts in a category with optional filtering by type, topic, tag, region, platform, or persona. Supports cursor-based pagination.",
    ...
    "response": "{ data: { id: string; created_at: string; language: string; platforms: object[]; prompt: string; regions: object[]; status: 'active' | 'disabled'; topic: object; updated_at: string; analysis_types?: 'visibility' | 'sentiment' | 'accuracy'[]; personas?: object[]; prompt_type?: string; tags?: object[]; }[]; info: { limit: number; next_cursor: string; total_rows: number; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/org/categories/$CATEGORY_ID/prompts \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; created_at: string; is_owned: boolean; logo_url: string; name: string; website: string; alternate_domains?: string[]; }[]",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/org/categories/$CATEGORY_ID/assets \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/org/categories/$CATEGORY_ID/personas \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Create one or more prompts in a category. Topics and tags are auto-created if referenced by name and not yet existing. Use dry_run to preview without persisting.",
  ...
  },
  {
    ...
    "description": "Update one or more existing prompts. Only provided fields are changed. Dimension fields (regions, platforms, personas, tags) replace the full set when provided. Use dry_run to preview without persisting.",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/org/categories/$CATEGORY_ID/prompts/status \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"prompt_ids\": [\n            \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n          ],\n          \"status\": \"active\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/prompts/answers \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"category_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"end_date\": \"2019-12-27T18:11:19.117Z\",\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ data: { dimensions: string[]; metrics: number[]; }[]; info: { total_rows: number; query?: object; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/reports/citations \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"category_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"end_date\": \"2019-12-27T18:11:19.117Z\",\n          \"metrics\": [\n            \"count\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/reports/visibility \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"category_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"end_date\": \"2019-12-27T18:11:19.117Z\",\n          \"metrics\": [\n            \"share_of_voice\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/reports/sentiment \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"category_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"end_date\": \"2019-12-27T18:11:19.117Z\",\n          \"metrics\": [\n            \"positive\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/reports/referrals \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"domain\": \"domain\",\n          \"metrics\": [\n            \"visits\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/reports/bots \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"domain\": \"domain\",\n          \"metrics\": [\n            \"count\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Get referral traffic report from the hourly aggregated materialized view (UTC-based).\n\nSupports date_interval=\"hour\", calendar intervals through \"year\", \"quarter\", and \"relative_week\".",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v2/reports/referrals \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"domain\": \"domain\",\n          \"metrics\": [\n            \"visits\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v2/reports/bots \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"domain\": \"domain\",\n          \"metrics\": [\n            \"count\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/reports/query-fanouts \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"category_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"end_date\": \"2019-12-27T18:11:19.117Z\",\n          \"metrics\": [\n            \"fanouts_per_execution\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ host: string; ip: string; method: string; org_id: string; path: string; status_code: number; timestamp: string; user_agent: string; bytes_sent?: number; duration_ms?: number; query_params?: object; referer?: string; }[] | { data: object[]; info: object; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/logs/raw \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"domain\": \"domain\",\n          \"metrics\": [\n            \"count\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ bot_name: string; bot_provider: string; bot_types: 'ai_assistant' | 'ai_training' | 'index' | 'ai_agent'[]; host: string; ip: string; method: string; org_id: string; path: string; status_code: number; timestamp: string; user_agent: string; bytes_sent?: number; duration_ms?: number; query_params?: object; referer?: string; }[] | { data: object[]; info: object; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/logs/raw/bots \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{\n          \"domain\": \"domain\",\n          \"metrics\": [\n            \"count\"\n          ],\n          \"start_date\": \"2019-12-27T18:11:19.117Z\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ data: { id: string; created_at: string; extracted_input: string; status: string; title: string; type: 'file' | 'text' | 'url'; }[]; info: { query: { asset_id: string; pagination?: pagination; }; total_rows: number; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/content/$ASSET_ID/optimization \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { aeo_content_score: { target_zone: object; value: number; }; analysis: { breakdown: object[]; }; content: { format: 'markdown' | 'html'; value: string; }; inputs: { prompt: object; top_citations: string[]; topic: object; user: object; }; recommendations: { impact: object; status: 'done' | 'pending'; suggestion: object; title: string; }[]; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/content/$ASSET_ID/optimization/$CONTENT_ID \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { id: string; created_at: string; name: string; organization_id: string; status: 'draft' | 'published' | 'unknown'; description?: string; }[]; pagination?: { limit?: number; next_cursor?: string; }; }",
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; name: string; organization_id: string; schema: { input: object; output: object; }; status: 'draft' | 'published' | 'unknown'; description?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/agents/$AGENT_ID \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; agent_id: string; status: 'queued' | 'running' | 'succeeded' | 'failed' | 'cancelled' | 'skipped' | 'unknown'; started_at?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/agents/$AGENT_ID/runs \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; agent_id: string; status: 'queued' | 'running' | 'succeeded' | 'failed' | 'cancelled' | 'skipped' | 'unknown'; error?: object; finished_at?: string; outputs?: object; started_at?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tryprofound.com/v1/agents/$AGENT_ID/runs/$RUN_ID \\\n    -H \"X-API-Key: $PROFOUND_API_KEY\""
      }
    }
  }
];
