...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; inaccurateCount: number; name: string; responseAccuracy: number; share: number; accuracyChange?: number; accurateCount?: number; citationCategory?: string; groupIds?: object; groupNames?: object; inaccurateCountChange?: number; promptCount?: number; shareChange?: number; }[]; totalCount: number; }',
    markdown:
      "## create_breakdown\n\n`client.reports.accuracy.createBreakdown(category_id: string, end_date: string, start_date: string, breakdown_by?: 'citation' | 'platform' | 'topic' | 'prompt' | 'tag' | 'region' | 'persona' | 'theme', citation_categories?: string[], comparison_end_date?: string, comparison_start_date?: string, date_bucket?: string, exclude_topic_ids?: boolean, group_by?: 'platform' | 'topic' | 'prompt' | 'tag' | 'region' | 'persona' | 'theme' | 'date'[], include_no_persona?: boolean, include_no_tag?: boolean, limit?: number, offset?: number, persona_ids?: string[], platform_ids?: string[], prompt_ids?: string[], region_ids?: string[], search_query?: string, sort_by?: 'citationShare' | 'accuracy', sort_order?: 'asc' | 'desc', tag_filter_type?: 'all' | 'any', tag_ids?: string[], topic_ids?: string[]): { data: object[]; totalCount: number; }`\n\n**post** `/v1/reports/accuracy/breakdown`\n\nAccuracy Breakdown\n\n### Parameters\n\n- `category_id: string`\n\n- `end_date: string`\n\n- `start_date: string`\n\n- `breakdown_by?: 'citation' | 'platform' | 'topic' | 'prompt' | 'tag' | 'region' | 'persona' | 'theme'`\n\n- `citation_categories?: string[]`\n\n- `comparison_end_date?: string`\n\n- `comparison_start_date?: string`\n\n- `date_bucket?: string`\n\n- `exclude_topic_ids?: boolean`\n\n- `group_by?: 'platform' | 'topic' | 'prompt' | 'tag' | 'region' | 'persona' | 'theme' | 'date'[]`\n\n- `include_no_persona?: boolean`\n\n- `include_no_tag?: boolean`\n\n- `limit?: number`\n\n- `offset?: number`\n\n- `persona_ids?: string[]`\n\n- `platform_ids?: string[]`\n\n- `prompt_ids?: string[]`\n\n- `region_ids?: string[]`\n\n- `search_query?: string`\n\n- `sort_by?: 'citationShare' | 'accuracy'`\n\n- `sort_order?: 'asc' | 'desc'`\n\n- `tag_filter_type?: 'all' | 'any'`\n\n- `tag_ids?: string[]`\n\n- `topic_ids?: string[]`\n\n### Returns\n\n- `{ data: { id: string; inaccurateCount: number; name: string; responseAccuracy: number; share: number; accuracyChange?: number; accurateCount?: number; citationCategory?: string; groupIds?: object; groupNames?: object; inaccurateCountChange?: number; promptCount?: number; shareChange?: number; }[]; totalCount: number; }`\n\n  - `data: { id: string; inaccurateCount: number; name: string; responseAccuracy: number; share: number; accuracyChange?: number; accurateCount?: number; citationCategory?: string; groupIds?: object; groupNames?: object; inaccurateCountChange?: number; promptCount?: number; shareChange?: number; }[]`\n  - `totalCount: number`\n\n### Example\n\n```typescript\nimport Profound from '@profoundai/client';\n\nconst client = new Profound();\n\nconst response = await client.reports.accuracy.createBreakdown({\n  category_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n  end_date: 'end_date',\n  start_date: 'start_date',\n});\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
